...
const StyledHeartFilledIcon = styled('svg', forwardRef)`
  flex-shrink: 0;
`;

export const HeartFilledIcon = forwardRef<
  SVGSVGElement,
...
const StyledHeartOutlineIcon = styled('svg', forwardRef)`
  flex-shrink: 0;
`;
...
export { CommonToggle as main } from '../common.js';
